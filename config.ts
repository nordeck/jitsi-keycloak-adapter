// keycloak
export const KEYCLOAK_ORIGIN = Deno.env.get("KEYCLOAK_ORIGIN") || "https://ucs-sso-ng.mydomain.corp";
...
export const JWT_EXP_SECOND = Deno.env.get("JWT_EXP_SECOND") || 3600;

// adapter
export const HOSTNAME = Deno.env.get("HOSTNAME") || "127.0.0.1";
export const PORT = Deno.env.get("PORT") || 9000;
